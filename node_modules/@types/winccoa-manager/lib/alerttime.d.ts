 ...
 */
export declare class WinccoaAlertTime {
    date: Date;
    count: number;
    dpe: string;
    /**
     * Constructor.
     * @param date Time of alarm occurrence
     * @param count Serial number
     * @param dpe Data point element name
     * @see - {@link WinccoaManager.alertSet}
     * - {@link WinccoaManager.alertSetWait}
     * - {@link WinccoaManager.alertSetTimed}
     * - {@link WinccoaManager.alertSetTimedWait}
     * @example
     * #### TypeScript
     * ``` ts
     ...
     * ```
     */
    constructor(date: Date, count: number, dpe: string);
}
