...
exports.WinccoaCtrlScript = void 0;
// load the cltr script class from the DLL
//@ts-expect-error Importing an AddOn without type declaration
const winccoaconnection_1 = require("C:/Siemens/Automation/WinCC_OA/3.20/bin/winccoaconnection");
...
class WinccoaCtrlScript {
     ...
     * @see WinccoaOptions
     */
    constructor(manager, ctrlCode) {
        // this typecheck is necessary for JavaScript
        if (manager && manager instanceof binding_1.WinccoaManager) {
            this.manager = manager;
        }
        else {
            throw new Error('Constructor must be called with a valid WinccoaManager instance');
        }
        // store and initialize script
        this.script = new winccoaconnection_1.WinccoaCtrlScript();
        this.script.initScript(ctrlCode, this.manager);
    }
    /**
     ...
     * ```
     */
    start(functionName = 'main', functionParams = [], paramTypes = []) {
        return this.script.callFunction(functionName, functionParams, paramTypes, this.manager);
    }
    /**
...
exports.WinccoaCtrlScript = WinccoaCtrlScript;
